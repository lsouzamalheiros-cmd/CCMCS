...
st.set_page_config(page_title="Sistema Escolar - CCMCS by Leandro Malheiros V2.0.3 ", layout="centered")
...
@st.cache_resource
def conectar():
    uri = "mongodb+srv://lsouzamalheiros_db_user:malheiros76@cluster0.katnwuj.mongodb.net/escola?retryWrites=true&w=majority&authSource=admin"
...
👨‍🏫 Escola [CCM Sertãozinho]
📞 Contato: [41 3453-2022]
...
def exportar_ocorrencias_para_pdf(ocorrencias, nome_arquivo):
    ...
    elementos.append(Paragraph(
        "<b>COLÉGIO CÍVICO MILITAR SERTÃOZINHO</b>",
        cabecalho_style
    ))
